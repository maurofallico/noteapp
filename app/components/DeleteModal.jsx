...
const DeleteModal = forwardRef(({ note, reload, setReload, loading, setLoading }, ref) => {
    ...
    return(
        ...
        </div>) : (<div className="text-black bg-blue-50 shadow-2xl border-2 border-slate-700 p-3 sm:rounded-xl flex flex-col items-center gap-2 w-screen sm:w-[460px] h-[140px]">
            <button onClick={(e) => {
              e.stopPropagation()
              setIsOpen(false)}
            }
